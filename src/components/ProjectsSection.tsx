...
const PROJECTS = [
  ...
  },
  {
    num: "03",
    name: "G_AI",
    category: "Chrome Extension — AI Agent for Crypto Insights",
    href: "https://github.com/eradityashewale",
    client: "Dubai",
    system: "AI Agent + Chrome Extension in Side Panel",
    tech: "Python, FastAPI, Django, LangChain, LangSmith, OpenAI, Groq API, AWS SQS, PostgreSQL, Pandas",
    roles: "AI Agent Developer / Python Backend Developer / Data Engineer / DevOps Engineer",
    description:
      "An AI Agent system built with LangChain, LangSmith, OpenAI, and Groq that spots crypto tickers (like $BTC) in tweets and delivers intelligent, context-aware insights — live price charts, sentiment, and one-click trading — right inside Twitter.",
    responsibilities: [
      "Built an AI Agent using LangChain, LangSmith, OpenAI, and Groq API to deliver context-aware responses based on live tweet content and cashtag activity.",
      "Built a real-time tweet ingestion pipeline (AWS SQS) that captures live Twitter data and persists structured token/tweet data in PostgreSQL.",
      "Added live candlestick charts with sentiment overlays and trading shortcuts for Binance and KuCoin DEX.",
      "Built influencer detection to surface top Twitter influencers mentioning specific cashtags across configurable timeframes.",
      "Integrated multiple crypto data providers — CoinGecko, GeckoTerminal, DexScreener, and CoinMarketCap — for real-time price aggregation.",
      "Monitored and evaluated agent performance end-to-end using LangSmith tracing in production.",
    ],
